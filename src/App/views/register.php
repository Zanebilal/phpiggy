  ...
  <?php include $this->resolve("partials/_csrf.php");?>
    ...
    <label class="block">
      ...
      <input
        ...
        <!--check if tere are errors for email field-->
    ...
    <label class="block">
      ...
      >
        ...
        <option value="Canada" <?php echo $oldFormData['country'] === 'Mexico' ? 'selected' : '';?>>Canada</option>
      ...
      <div class="mt-2">
        <div>
          <label class="inline-flex items-center">
            <input
              value="<?php echo e($oldFormData['tos'] ?? false ? 'checked' : '') ;?>"
              name="tos"
